...
public class DonationAdapter extends RecyclerView.Adapter<DonationAdapter.MyViewHolder> {
  ...
  public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public void onClick(View v) {
      ...
      switch (v.getId()) {
        case R.id.donation_package_title:
          listener.onViewPackage(v, getAdapterPosition());
          break;
        case R.id.donation_package_image:
          listener.onAddToCart(v, getAdapterPosition());
          break;
        default:
          break;
      }
  ...
  public DonationAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View donationRecyclerView = LayoutInflater.from(
      parent.getContext()
    ).inflate(
      R.layout.donation_package_card, parent, false
    );

    return new MyViewHolder(donationRecyclerView);
  }
